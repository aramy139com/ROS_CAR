...
USART_TypeDef*  SERIAL_USART[SERIALn] = {ROS_SERIAL1, ROS_SERIAL2, ROS_SERIAL3};
GPIO_TypeDef*   SERIAL_PORT[SERIALn] = {ROS_SERIAL1_GPIO_PORT, ROS_SERIAL2_GPIO_PORT, ROS_SERIAL3_GPIO_PORT}; 
const uint32_t  SERIAL_USART_CLK[SERIALn] = {ROS_SERIAL1_CLK, ROS_SERIAL2_CLK, ROS_SERIAL3_CLK};
const uint32_t  SERIAL_PORT_CLK[SERIALn] = {ROS_SERIAL1_GPIO_CLK, ROS_SERIAL2_GPIO_CLK, ROS_SERIAL3_GPIO_CLK};
const uint16_t  SERIAL_TX_PIN[SERIALn] = {ROS_SERIAL1_TX_PIN, ROS_SERIAL2_TX_PIN, ROS_SERIAL3_TX_PIN}; 
const uint16_t  SERIAL_RX_PIN[SERIALn] = {ROS_SERIAL1_RX_PIN, ROS_SERIAL2_RX_PIN, ROS_SERIAL3_RX_PIN}; 
const uint16_t  SERIAL_IRQn[SERIALn] = {ROS_SERIAL1_IRQ, ROS_SERIAL2_IRQ, ROS_SERIAL3_IRQ};
const uint16_t  SERILA_NVIC[SERIALn] = {ROS_SERIAL1_NVIC, ROS_SERIAL2_NVIC, ROS_SERIAL3_NVIC};
